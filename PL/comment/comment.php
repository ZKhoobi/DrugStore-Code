...
<head>
    ...
    <title>داروخانه دکتر آل احمد - نظرات</title>
        ...
        <div class="container" dir="rtl">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right" style="font-size:large; font-family:'B Mitra'">
                    ...
                    <li class="active">
                        <a href="#">نظرات <i class="fa fa-commenting"></i></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
            ...
            <div class="col-lg-8">                
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <form role="form">
                        ...
                        <div class="checkbox">
                            <label><input type="checkbox" value="" checked>در صورت پاسخ به نظر من را مطلع کن</label>
                        </div>
                        <button type="submit" class="btn btn-success" >ثبت نظر<i class="fa fa-comment"></i></button>
