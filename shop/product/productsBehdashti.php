...
<head>
    ...
    <title>داروخانه دکتر آل احمد - بهداشتی</title>
                ...
                <ul class="nav navbar-nav navbar-right" style="font-size:large; font-family:'B Mitra'">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#" style="direction:rtl">بهداشتی</a></li>
    ...
    <div class="container">
        <!------------container------->
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="#"><img src="../../images/behdashti/6.png" alt="" /></a>
                           <!-- <div class="caption">-->
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="#"><img src="../../images/behdashti/2.png" alt="" /></a>
                            <!-- <div class="caption">-->
                            <p><br />نام و توضیح مختصری از محصول...</p>
                            <a href="#" id="plus" style="float:left"><i class="fa fa-cart-plus fa-3x"></i></a>
                            <p class="price">4,000 تومان</p>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="#"><img src="../../images/behdashti/3.png" alt="" /></a>
                            <!-- <div class="caption">-->
                            <p><br />نام و توضیح مختصری از محصول...</p>
                            <a href="#" id="plus" style="float:left"><i class="fa fa-cart-plus fa-3x"></i></a>
                            <p class="price">4,000 تومان</p>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="#"><img src="../../images/behdashti/4.png" alt="" /></a>
                            <!-- <div class="caption">-->
                            <p><br />نام و توضیح مختصری از محصول...</p>
                            <a href="#" id="plus" style="float:left"><i class="fa fa-cart-plus fa-3x"></i></a>
                            <p class="price">4,000 تومان</p>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="#"><img src="../../images/behdashti/5.png" alt="" /></a>
                            <!-- <div class="caption">-->
                            <p><br />نام و توضیح مختصری از محصول...</p>
                            <a href="#" id="plus" style="float:left"><i class="fa fa-cart-plus fa-3x"></i></a>
                            <p class="price">4,000 تومان</p>
