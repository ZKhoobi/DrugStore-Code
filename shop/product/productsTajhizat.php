...
<body>
                ...
                <ul class="nav navbar-nav navbar-right" style="font-size:large; font-family:'B Mitra'">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu ">
                            ...
                            <li><a href="productArayeshi" style="direction:rtl">آرایشی</a></li>
                            <li><a href="productsBehdashti.php" style="direction:rtl">بهداشتی</a></li>
                            <li><a href="#" style="direction:rtl">تجهیزات پزشکی</a></li>
    ...
    <div class="container">
        <!------------container------->
				...
				<?php
				$product_array = $db_handle->runQuery("SELECT * FROM products where categoryId='2' ORDER BY id ASC");
