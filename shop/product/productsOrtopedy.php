...
<head>
    ...
    <title>داروخانه دکتر آل احمد - ارتوپدی</title>
                ...
                <ul class="nav navbar-nav navbar-right" style="font-size:large; font-family:'B Mitra'">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu ">
                            <li style="direction:rtl"><a href="#" style="direction:rtl">ارتوپدی</a></li>
    ...
    <div class="container">
        <!------------container------->
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="oneProduct.php"><img src="../../images/ortopedy/1.jpg" alt="" /></a>
                           <!-- <div class="caption">-->
                                <p><br />نام و توضیح مختصری از محصول...</p>
                                <a href="oneProduct.php" id="plus" style="float:left"><i class="fa fa-cart-plus fa-3x"></i></a>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="#"><img src="../../images/ortopedy/2.jpg" alt="" /></a>
                            <!-- <div class="caption">-->
                            <p><br />نام و توضیح مختصری از محصول...</p>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="#"><img src="../../images/ortopedy/3.jpg" alt="" /></a>
                            <!-- <div class="caption">-->
                            <p><br />نام و توضیح مختصری از محصول...</p>
                            <a href="#" id="plus" style="float:left"><i class="fa fa-cart-plus fa-3x"></i></a>
                            <p class="price">4,000 تومان</p>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="#"><img src="../../images/ortopedy/4.jpg" alt="" /></a>
                            <!-- <div class="caption">-->
                            <p><br />نام و توضیح مختصری از محصول...</p>
                            <a href="#" id="plus" style="float:left"><i class="fa fa-cart-plus fa-3x"></i></a>
                            <p class="price">4,000 تومان</p>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <a href="#"><img src="../../images/ortopedy/5.jpg" alt="" /></a>
                            <!-- <div class="caption">-->
                            <p><br />نام و توضیح مختصری از محصول...</p>
                            <a href="#" id="plus" style="float:left"><i class="fa fa-cart-plus fa-3x"></i></a>
                            <p class="price">4,000 تومان</p>
